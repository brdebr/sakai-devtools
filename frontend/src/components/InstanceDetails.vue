        ...
        <v-card-text class="pt-5">
          <v-row no-gutters>
            <v-col cols="12" class="mb-6 mt-2">
              <v-text-field outlined hide-details label="Path" placeholder="C:\sakai-source\" :value="$store.getters['app/selectedInstance'].path"/>
            </v-col>
          </v-row>
          <v-row no-gutters>
            ...
            <v-col cols="6" class="pl-2">
              ...
              <v-card-text class="py-2">
                <v-row no-gutters align="center">
                  ...
                  <v-col class="flex-grow-0 mx-3" v-for="goal in mavenGoals" :key="goal">
                    <v-checkbox
                      hide-details
                      class="mt-0 py-0"
