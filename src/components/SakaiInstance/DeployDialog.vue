                  ...
                  >
                    ...
                    >
                      ...
                      <v-expansion-panel-content class="grey darken-3 no-x-paddings">
                        ...
                        >
                          <v-col
                            class="py-2 px-7 mx-auto black white--text terminal-like"
                            v-text="tool.log+'\n'"
                          />
                        </v-row>
...
export default class DeployDialog extends Vue {
  ...
  get percentage() {
    return (
      (this.states.filter(
        el => el.state !== "initial" && el.state !== "deploying"
      ).length *
        100) /
      this.states.length
    );
  ...
  getStateIcon(state: string) {
    switch (state) {
      ...
      case "deploying":
        return "fas fa-sync fa-spin blue-grey--text";
      case "success":
        return "far fa-check-square green--text";
      case "error":
        return "fas fa-exclamation-triangle red--text";
      case "warning":
        return "fas fa-minus-square warning--text";
    }
  }
