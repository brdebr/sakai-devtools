<template>
    <InstanceDetails v-if="$store.getters['app/selectedInstance']" :key="$store.getters['app/selectedInstance'].id" />
    <v-card dark
        class="blue darken-2 mx-auto" v-else>
...
<script lang="ts">
// TODO: Move the else to inside Instace
import Vue from "vue";
